    ...
    return (
      <div className="max-w-4xl mx-auto p-6 text-white">
        <div className="bg-gray-800 border border-yellow-500 rounded-lg p-6">
          ...
          <p className="text-gray-300">Product ID is missing from URL.</p>
        ...
        <div className="overflow-hidden rounded-3xl border border-stone-200 bg-white p-5 shadow-lg sm:p-8">
          <div className="flex flex-col gap-8 md:flex-row md:items-stretch">
            ...
            <div className="flex w-full flex-col md:w-1/2">
              ...
              {/* Main Image Container with Full Height */}
              <div className="relative h-[450px] sm:h-[550px] w-full overflow-hidden rounded-2xl bg-stone-100">
                {fullImageUrl ? (
                  <img
                    src={fullImageUrl}
                  ...
                  {productImages.map((image, index) => {
                    ...
                    return (
                      <button
                        ...
                        className={`h-20 w-20 flex-shrink-0 overflow-hidden rounded-xl border-2 bg-stone-100 transition-all ${
                          selectedImage === index
            ...
            <div className="flex w-full flex-col justify-between md:w-1/2">
              ...
              <div className="mt-8">
                <button
                  onClick={addtocart}
                  className="w-full rounded-xl bg-indigo-600 px-6 py-4 font-semibold text-white shadow-md transition-all duration-300 hover:bg-indigo-700 hover:shadow-lg hover:shadow-indigo-500/30 active:scale-95"
                >
                  Add to Cart
                </button>
                ...
                <div className="mt-5 grid grid-cols-2 gap-4">
                  <div className="rounded-xl bg-stone-50 p-4 text-center">
                    <p className="font-semibold text-stone-700">Secure</p>
                    <p className="mt-1 text-xs text-stone-400">Safe Shopping</p>
                  </div>

                  <div className="rounded-xl bg-stone-50 p-4 text-center">
                    <p className="font-semibold text-stone-700">Quality</p>
                    <p className="mt-1 text-xs text-stone-400">Premium Product</p>
                  </div>
                </div>
              </div>
